About python-keystoneclient-feedstock
=====================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/python-keystoneclient-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/python-keystoneclient-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add python-keystoneclient
# for installing globally
pixi global install python-keystoneclient
```
...
It is possible to list all of the versions of `python-keystoneclient` available on your platform:
...
```
pixi search python-keystoneclient --channel conda-forge
```
